...
data_path <- "/Users/ofia/Downloads/DataSet_No_Details.csv"
# Read the dataset
...
for (v in vars_to_plot) {
  ...
  print(plot)
  ggsave(filename = paste0("/Users/ofia/Desktop/Graphs/imputation_density_", v, ".png"), 
...
boxplot1 <- ggplot(outliers_data, aes(x = variable, y = value)) +
  ...
  theme_minimal()
print(boxplot1)
ggsave(filename = "/Users/ofia/Desktop/Graphs/outlier_detection_boxplot.png", 
...
print(boxplot2)
ggsave(filename = "/Users/ofia/Desktop/Graphs/all_numeric_outlier_boxplot.png", 
...
lof_hist <- ggplot(lof_df, aes(x = lof_score)) +
  ...
  theme_minimal()
print(lof_hist)
ggsave(filename = "/Users/ofia/Desktop/Graphs/lof_histogram.png", 
...
lof_scatter <- ggplot(lof_df, aes(x = lipids1, y = lipids2)) +
  ...
  theme_minimal()
print(lof_scatter)
ggsave(filename = "/Users/ofia/Desktop/Graphs/lof_scatterplot.png", 
...
ggsave(filename = "/Users/ofia/Desktop/Graphs/lof_outliers_scatterplot.png", 
